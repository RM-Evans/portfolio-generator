...
module.exports = templateData => {
  ...
  //will create three variables based on data in templateData
  const { projects, about, ...header } = templateData
  //console.log('projects', projects,'about section', about,'and the header', header)
  return `
  <!DOCTYPE html>
  <html lang="en">
